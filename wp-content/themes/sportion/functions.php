...
/*Add the demo file*/
function sportion_add_demo_files($demos) {
    $demos[] = array(
        'import_file_name'             => esc_html__( 'Child - Sportion', 'sportion' ),
        'local_import_file'            => trailingslashit( get_stylesheet_directory() ) . 'demo-content/sportion/newsphere.xml',
        'local_import_widget_file'     => trailingslashit( get_stylesheet_directory() ) . 'demo-content/sportion/newsphere.wie',
        'local_import_customizer_file' => trailingslashit( get_stylesheet_directory() ) . 'demo-content/sportion/newsphere.dat',
        'import_preview_image_url'     => trailingslashit( get_stylesheet_directory_uri() ) . 'demo-content/assets/newsphere-sportion.jpg',
        'preview_url'                  => 'https://demo.afthemes.com/newsphere/sportion',
    );
    return $demos;
}
add_filter( 'aft_demo_import_files', 'sportion_add_demo_files');

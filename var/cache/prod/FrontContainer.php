...
class FrontContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'new_sport', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir('C:\\xampp\\htdocs\\test_prestashop/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c9c4f02ceb75ce0d209ff8645a4ff1e0e456dea47aa87ff6262b4552a8ff49ae');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\test_prestashop/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\test_prestashop/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'tAcZPWfhieO82WFy4AEId2rP0O67yfxK8gPSGqw5THF5b0V6kmEjU7gr',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-10-04',
            'locale' => 'vi-VN',
            'cookie_key' => 'heM0AqSPWUyAvC9jZgPoKa11G4dOTd3XSc4eOLFT47cf8d25a9iiENaZ',
            'cookie_iv' => 'fEohau4s',
            'new_cookie_key' => 'def000004aa813b8fa570175449ed1206ee32b450fe562c2803a46683cf0e1e5476941d01a328d4707f9947407f9025576594b7960da4656bfcabe5935e01dcc30c122ea',
            'cache.driver' => 'array',
            'kernel.bundles' => [

            ],
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\test_prestashop/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\test_prestashop/var/cache/prod/',
            ...
            'ps_cache_dir' => 'C:\\xampp\\htdocs\\test_prestashop/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\test_prestashop/var/cache/prod//doctrine/orm/Proxies',
